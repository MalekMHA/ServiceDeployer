...
public class FeasibilityFastTimeOverNodes {

	public static void main(String[] args) {
		Random random = new Random();
		String file = "FeasibilityFastTimeOverNodes.csv";
		FileWriter fw;
			try {
				...
				for (int size = 1; size <= 51; size += 5) {
					...
					for (int sample = 0; sample < 100; sample++) {
						...
						//List<Path> validPaths = Traversal.TraverseGraphFirst(expandedGraph, abstracted.getProducer().getProcessNode(), abstracted.getConsumer().getProcessNode(), 14000, false, new ArrayList<Edge>(), 0);
